...
<head>
  ...
  <link href="<?php echo e(asset('vendors/morris/morris.css')); ?>" rel="stylesheet">
  <!-- Custom Theme Style -->
  <link href="<?php echo e(asset('build/css/custom.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('flags/flags.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('css/jquery.steps.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('vendors/airdatepicker/dist/css/datepicker.min.css')); ?>" rel="stylesheet">
...
<div class="container body">
      ...
      <div class="left_col scroll-view">
        ...
        <div class="profile clearfix">
          <div class="profile_pic">
            <img src="<?php echo e(asset('').'/'.$configuration->logo); ?>" alt="logo"  class="img-thumbnail profile_img">
          </div>
  ...
  <?php echo $__env->make('layouts._help_guidelines', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('plugins/summernote/dist/plugin/image/summernote-image-attributes.js')); ?>"></script>
...
<script src="<?php echo e(asset('vendors/raphael/raphael.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/morris/morris.js')); ?>"></script>
...
<script src="<?php echo e(asset('js/require.js')); ?>"></script>
...
<script src="<?php echo e(asset('vendors/airdatepicker/dist/js/datepicker.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/airdatepicker/dist/js/i18n/datepicker.en.js')); ?>"></script>
...
<?php /**PATH /home/jalakdev/www/crm/resources/views/layouts/master.blade.php ENDPATH**/ ?>